...
**131 modules documented** across 10 folders.
...
- 🔧 `api_manual_order` — …
- 🔧 `api_margin_history` — Day margin-utilization timeline (task 74) — reconstructed from order_store
- 🔧 `api_morning_brief` — …
...
- 🔧 `api_rms_summary` — Combined RMS view (Stage 2): per-strategy + global capital used/available,
