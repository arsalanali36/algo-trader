...
## TRAP #112 — Rolling option series (WEEK flag) ROLLS to the next contract after expiry — any hold whose exit crosses the expiry date prices TWO DIFFERENT contracts, and a wide search engine WILL find and exploit that seam.
